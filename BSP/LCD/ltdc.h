...
#define LTDC_BL_GPIO_PIN                SYS_GPIO_PIN12
#define LTDC_BL_GPIO_CLK_ENABLE()       do{ RCC->AHB4ENR |= 1 << 3; }while(0)   /* 所在IO口时钟使能 */

#define LTDC_RST_GPIO_PORT              GPIOD
#define LTDC_RST_GPIO_PIN               SYS_GPIO_PIN11
#define LTDC_RST_GPIO_CLK_ENABLE()      do{ RCC->AHB4ENR |= 1 << 3; }while(0)   /* 所在IO口时钟使能 */
